<?php
	...
	if($Core->CheckAdmin())
	{
		...
		$Button .= '<a href="index.php?pages=admin_logs"><button class="przycisk">0</button></a>&nbsp;&nbsp;&nbsp;';
		...
		if($Pages != 0)
		{
			...
			if($Number == 0)
			{
				...
				$Button .= '<a href="index.php?pages=admin_logs"><button class="przycisk"><i class="fa fa-arrow-left"></i></button></a>&nbsp;&nbsp;&nbsp;';
			...
			else
			{
				...
				$Button .= '<a href="index.php?pages=admin_logs&id='.$Number.'"><button class="przycisk"><i class="fa fa-arrow-left"></i></button></a>&nbsp;&nbsp;&nbsp;';
		...
		if($Pages != $PagesNumber)
		{
			...
			$Button .= '<a href="index.php?pages=admin_logs&id='.$Number.'"><button class="przycisk"><i class="fa fa-arrow-right"></i></button></a>&nbsp;&nbsp;&nbsp;';
	
		}
	
		$Button .= '<a href="index.php?pages=admin_logs&id='.$PagesNumber.'"><button class="przycisk">'.$PagesNumber.'</button></a>';
